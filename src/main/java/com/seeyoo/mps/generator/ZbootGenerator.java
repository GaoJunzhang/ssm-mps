package com.seeyoo.mps.generator;

import cn.hutool.core.util.StrUtil;
import com.seeyoo.mps.generator.bean.Entity;
...
public class ZbootGenerator {
     ...
     * 建议仅需修改
     */
    private static final String className = "TerminalExpand";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "终端扩展";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.seeyoo.mps.model";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.seeyoo.mps.dao";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.seeyoo.mps.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.seeyoo.mps.service.impl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.seeyoo.mps.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com/seeyoo/mps/generator/template";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ dotToLine(daoPackage) + "/" +className + "Repository.java";
